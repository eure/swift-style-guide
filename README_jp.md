...
# 目次
- [スタイルと慣習](#styles-and-conventions)
	- [フォーマット](#formatting)
	    - [セミコロン (`;`)](#semicolons)
	    - [スペース](#whitespaces)
	    - [コンマ (`,`)](#commas)
	    ...
	    - [括弧 (`{}`)](#braces)
	    - [プロパティ](#properties)
	    - [条件分岐](#control-flow-statements)
	- [命名](#naming)
	    - [大文字、小文字](#capitalization)
	    - [名前の付け方](#semantics)
	- [依存関係](#dependencies)
	    - [Import文](#import-statements)
	- [宣言の順序](#declaration-order)
- [ベストプラクティス](#best-practices)
	- [コメント](#comments)
	- [ダイナミックと安全性](#protection-from-dynamism)
	- [Access Modifiers](#access-modifiers)
	- [タイプインターフェース](#type-inference)
...
***理由:*** 文末にセミコロンを付けることで実用的なメリットはありません。しかし、Objective-Cのコードをコピー&ペーストをして付いたままになっていることは良しとします。
